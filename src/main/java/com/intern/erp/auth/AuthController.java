...
public class AuthController {
    ...
    public AuthController(UserAccountRepository userRepo, PasswordEncoder passwordEncoder, OutboxService outboxService, JwtUtil jwtUtil) {
    ...
    public record LoginResponse(boolean success, String message, String username, Set<String> roles, String token) {}
    ...
    public ResponseEntity<?> login(@RequestBody LoginRequest req) {
        ...
        return ResponseEntity.ok(new LoginResponse(true, "Login successful", user.getUsername(), toRoleNames(user.getRoles()), token));
    }
    ...
    public Map<String, Object> logout() {
        // Stateless JWT logout is handled by client (removing token)
